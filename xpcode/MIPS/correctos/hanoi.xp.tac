	_str13_9 --> "Mover plato de "
	_str15_9 --> " a "
	_str17_9 --> "\n"
	_str27_7 --> "Escriba el numero de platos iniciales, que se moveran del plato 1 al 2\n"
	_str7_11 --> "Mover plato de "
	_str7_35 --> " a "
	_str7_47 --> "\n"
...
INIT:
		...
		CALL _t2 hanoi(0)(r->0)(arg->0)(tam=4)(numtp=8) 4
		EFUN _t2 16
		EXIT
...
_els1:
		...
		PARM _t3 2 12
		CALL _t4 hanoi(0)(r->0)(arg->0)(tam=4)(numtp=8) 4
		EFUN _t4 16
		WR   _str13_9 9
		WR   from_4(4)(r->0)(arg->1)(tam=4)(numtp=2) 2
		WR   _str15_9 9
		...
		PARM _t5 2 12
		CALL _t6 hanoi(0)(r->0)(arg->0)(tam=4)(numtp=8) 4
		EFUN _t6 16
		RET 
